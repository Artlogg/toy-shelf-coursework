...
При первом открытии сайта появится страница регистрации. Введите имя, email и возраст. После отправки формы пользователь создается через `POST /users`, а сайт переходит в магазин.
...
3. Начальная страница регистрации.
4. Успешная регистрация пользователя.
