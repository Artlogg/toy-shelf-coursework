...
Сначала открывается страница регистрации. Пользователь вводит имя, email и возраст, после чего профиль создается через `POST /users`, а сайт переходит в магазин.
